...
<head>
	...
	<meta name="author" content="Manoel Dias">
...
<body>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-9 col-lg-7 offset-md-1 offset-xxl-0">
                    <h1><span class="d-block" data-caption-animate="fadeInUp" data-caption-delay="100">Advocacia</span><span class="d-block text-light" data-caption-animate="fadeInUp" data-caption-delay="200">Profissionais Qualificados</span></h1>
          ...
          <div class="row row-30">
            <div class="col-md-4 wow fadeInUp">
              <div class="box-icon-2">
                ...
                <h5 class="title">Direitos Trabalhistas</h5>
      ...
      <section class="section section-lg bg-default" id="sobre">
        <div class="container">
          <h2><span class="text-light">Nossa</span> História</h2>
      ...
      <section class="section section-lg bg-gray-800" id="clientes">
        <div class="container text-center text-xl-left">
          ...
          <div class="owl-carousel owl-carousel-4 text-center" data-items="1" data-sm-items="3" data-md-items="4" data-lg-items="5" data-xl-items="6" data-dots="true" data-nav="false" data-stage-padding="15" data-loop="false" data-margin="30" data-mouse-drag="false">
            <div class="item"><a class="link-image" ><img src="img/profiles/hugo-profile.png" alt="" width="150" height="35"/></a>
        ...
        <div class="container text-center text-lg-left">
          ...
          <div class="row row-40">
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="img/gerente/paulo.png" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
                    <h5 class="title">Paulo</h5>
            ...
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="img/gerente/pedro.png" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
                    <h5 class="title">Pedro</h5>
            ...
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="img/gerente/maria.png" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
  ...
  <section class="page-section" id="contatos">
   ...
   <footer class="section footer-classic">
        ...
        <div class="col-md-3 mb-4" align="center">
          <span class="copyright"><i class="far fa-envelope mr-1"></i>dev.mdsj@gmail.com</span><br>
        ...
        <div class="col-md-6" align="center">
          <ul class="list-inline social-buttons">
            ...
            <li class="list-inline-item">
              <a href="https://www.facebook.com/dev.dias" target="_blank" title="Nossa Página no Facebbok">
                <i class="fab fa-facebook-f"></i>
              </a>
            </li>
            <li class="list-inline-item">
               <a href="https://www.instagram.com/devdias/" target="_blank" title="Nosso Instragram">
        ...
        <div class="col-md-3" align="center">
          <ul class="list-inline">
            ...
            <li class="list-inline-item">
             Manoel Dias - <a class="text-muted" href="http://api.whatsapp.com/send?1=pt_BR&phone=5591992464987" alt="91 99246-4987" target="_blank"><i class="fab fa-whatsapp mr-1"></i>91 99246-4987</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="footer-inner-2">
          <div class="container">
            <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span>. Todos os Direitos Reservados. Desenvolvido por <a href="https://www.Manoeldias.com.br">Manoel Dias</a></p>
          </div>
        </div>
      </footer>
